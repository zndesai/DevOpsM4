...
class UselessTestDetector {
	...
	private void createAnalysisReport(int count) {
		...
		try {
			...
			out.write("\n******************************************\n");
			System.out.println("Total Useless tests : " + uselessTests.size() + " \n");
			...
			out.write("Builds Analyzed : " + count + " \n");
			out.write("******************************************\n");
			out.write("******************************************\n");
			out.write("******************************************\n");
			out.write("Total Useless Tests : " + uselessTests.size() + " \n");
			while (it.hasNext()) {
			...
			out.write("******************************************\n");
			out.write("******************************************\n");
			out.write("Total Failed Tests : " + failedTests.size() + " \n");
